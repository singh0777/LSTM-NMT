...
def test():
    ...
    #seq_length = 1
    losses = []
    #smooth_loss = -np.log(1.0/len(words))#loss at iteration 0
    #losses.append(smooth_loss)
    
    losses2 = []
    #smooth_loss2 = -np.log(1.0/len(words2))#loss at iteration 0
    #losses2.append(smooth_loss2)
    ...
    while(True):
        if p >= len(data): 
            p = 0 # reset at the end of one epoch
